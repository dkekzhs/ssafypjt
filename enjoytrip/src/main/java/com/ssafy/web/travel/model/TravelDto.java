...
public class TravelDto {
	...
	public TravelDto(int sidoCode, int gugunCode, int contentTypeId) {
		this.setSidoCode(sidoCode);
	...
	public String toString() {
		return "MapInfoDto [contentId=" + contentId + ", contentTypeId=" + contentTypeId + ", title=" + title
